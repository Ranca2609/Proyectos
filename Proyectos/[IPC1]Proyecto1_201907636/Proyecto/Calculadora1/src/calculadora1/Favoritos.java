    ...
    super("RESULTADOS FAVORITOS");
     ...
     // panel0.setBackground(Color.WHITE);
      ...
      // this.getContentPane().add(panel0);
       ...
       text1.setSize(425, 80);
       text1.setLocation(10, 120);
       panel.add(text1);
       
       
       JTextField text2 = new JTextField();
       text2.setBackground(Color.GREEN);
       text2.setSize(425, 80);
       text2.setLocation(10, 220);
       panel.add(text2);
       ...
       text3.setSize(425, 80);
       text3.setLocation(10, 320);
       panel.add(text3);
       ...
       JLabel L4 = new JLabel("FAVORITOS");
