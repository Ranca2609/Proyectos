 ...
 */
public class EjemploPartes extends JFrame {
    public JPanel panel0;
public EjemploPartes(){
        super("EJEMPLO INTEGRACION POR PARTES");
...
private void label(){
        JLabel L0 = new JLabel("EJEMPLO 1");
        L0.setLocation(360, 20);
        L0.setFont(new Font("Lucida Sans", Font.BOLD,20));
        L0.setForeground(new Color(255,204,0));
        L0.setSize(300, 40);
        panel0.add(L0);
    
        JLabel L1 = new JLabel(new ImageIcon("partes.png"));
    ...
    ActionListener a1 = new ActionListener(){
       public void actionPerformed6(){
        ...
        public void actionPerformed(ActionEvent e) {
             ...
             PorPartes ven9Nueva = new PorPartes();
